...
import { SiBootstrap, SiFramer, SiJavascript, SiLichess, SiMongodb, SiPostman, SiReact, SiRedux, SiTailwindcss } from "react-icons/si";
            ...
            <div className="p-5 border-2 border-red-400 flex flex-col lg:flex-col items-center justify-center ">
              <div className="p-2 sm:p-10 border-2 flex flex-col lg:flex-row items-center space-y-3 lg:space-y-0 lg:space-x-16 justify-center">
                ...
                <div className="card w-full h-full  ">
                  <div
                    href="#"
                    className="p-2 flex flex-row items-center bg-white rounded-lg border shadow-md sm:flex-row md:max-w-6xl md:max-h-96 hover:cursor-pointer"
                  >
                    <Image
                      width="500%"
                      height="1000%"
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <div className="text-black flex flex-row space-x-3 py-2">
                        <span>
                          <SiReact className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150" />
                        </span>
                        <span>
                          <SiMongodb  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <FaNodeJs  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <SiPostman  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                      </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <div className="text-black flex flex-row space-x-3 py-2">
                        ...
                        <span>
                          <SiBootstrap className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150" />
                        </span>
                        <span>
                          <SiLichess  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <SiPostman  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <AiOutlineApi  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                      </div>
                      <div className="flex flex-row items-center justify-between mt-3  bg-slate-300 ">
                        <button className="bg-indigo-900 text-sm sm:text-base text-white p-1 px-2 rounded-md hover:bg-indigo-800  hover:cursor-pointer ">
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <div className="text-black flex flex-row space-x-3 py-2">
                        ...
                        <span>
                          <SiFramer  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <SiBootstrap className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150" />
                        </span>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <div className="text-black flex flex-row space-x-3 py-2">
                        ...
                        <span>
                          <SiTailwindcss  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                      </div>
                      <div className="flex flex-row items-center justify-between mt-3  bg-slate-300 ">
                        <button className="bg-indigo-900 text-sm sm:text-base text-white p-1 px-2 rounded-md hover:bg-indigo-800  hover:cursor-pointer ">
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <div className="text-black flex flex-row space-x-3 py-2">
                        ...
                        <span>
                          <SiRedux  className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                ...
                <div className="card w-full h-full  ">
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between p-3 leading-normal ">
                      ...
                      <p className="mb-3 font-normal text-xsm sm:text-base text-gray-700 dark:text-gray-400">
                      Redify is the red version of Spotify. It is basically a clone of Spotify providing different songs. You can change, stop and play songs of your playlist easily and between different singers.
                      </p>
                      <hr className="m-auto text-black bg-black" />
                      <h3 className="text-sm sm:text-base text-black font-semibold">Technologies</h3>
                      <div className="text-black flex flex-row space-x-3 py-2">
                        <span>
                          <FaHtml5 className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150" />
                        </span>
                        <span>
                          <FaCss3 className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <SiJavascript className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                        <span>
                          <FaSpotify className="hover:text-purple-900 hover:border-[1px] hover:border-purple-900 hover:scale-150"/>
                        </span>
                      </div>
                      <div className="flex flex-row items-center justify-between mt-3  bg-slate-300 ">
                        <button className="bg-indigo-900 text-sm sm:text-base text-white p-1 px-2 rounded-md hover:bg-indigo-800  hover:cursor-pointer ">
