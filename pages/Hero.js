          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
              ...
              <div className="py-4 sm:py-8 px-3 space-y-3 space-x-0 sm:space-y-0 sm:space-x-10 ">
                <button className="text-white text-lg sm:text-xl font-bold py-3 px-6 bg-gradient-to-r from-teal-500/75 to-purple-500/50 rounded-2xl hover:border-[1px] border-white hover:drop-shadow-3xl ">Learn More</button>
