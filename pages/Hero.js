...
const Hero = () => {
        ...
        <div className="max-w-7xl mx-auto shadow ">
          ...
          <div className="flex flex-col xl:flex-row items-center justify-center">
            ...
            <div className="max-w-8xl mx-auto pt-20 px-4 sm:px-6 lg:px-8">
              ...
              <div className="w-full text-justify sm:text-clip md:w-4/5 xl:w-4/5 p-3 hover:drop-shadow-2xl bg-opacity-50">
                <p className="text-sm sm:text-2xl text-gray-100/80 font-medium sm:tracking-wider z-10 opacity-100">
                  Hello everyone, I am Mayank Maroliya and active Research Scholar in the Department of Mechanical Engineering, Indian Institute of Technology Bombay. I am currently pursuing my doctoral studies under the guidance of Prof. Sandeep Kumar Saha.
                </p>
              ...
              >
                ...
                <g>
                  <path
                    x="-173,694"
                    y="-173,694"
                    className="large-shadow fill-[#06FBFF]"
                ...
                <g>
                  <path
                    x="-136,996"
                    y="-136,996"
                    className="medium-shadow fill-[#06FBFF]"
                ...
                <g>
                  <path
                    x="-100,136"
                    y="-100,136"
                    className="small-shadow fill-[#06FBFF]"
                ...
                <g>
                  <path
                    x="-136,996"
                    y="-136,996"
                    className="medium fill-[#AEFEFF] opacity-100"
  ...
  first-letter:mr-3 first-letter:float-left">
                        ...
                        and one can learn according to his skill levels.
                      </p>
                      <a className="inline-flex items-center">
                        <img
                          alt="testimonial"
