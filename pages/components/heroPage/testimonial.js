...
const Testimonial = () => {
  ...
  const data = [
    {
      desc:"Mr. Mayank Maroliya is quite ambitious and career-driven. He works hard to accomplish his goals and is committed to his work. He is emotionally mature, confident & good-natured. I have known him for the past three years as an undergraduate student, his B. Tech Project Supervising faculty, and one of his course coordinators at Inidan Institute of Technology Indore. He is pretty interactive and endorses the discussions with cogency and natural ease.",
      title:"Dr. Devendra Deshmukh, Associate Professor",
      subtitle:"Department of Mechanical Engineering, Indian Institute of Technology, Indore."
    },
    {
      desc:"Mr. Mayank has a well-groomed personality, and a specific focus on his future, and is a Ph.D. scholar under my supervision at IIT Bombay. He greatly understands subjects and often proved his conceptual ability and creative outlook during project discussions. He always comes up with new ideas and used to post intelligent questions. Throughout discussions, he is extremely diligent and meticulous. He is a PMRF fellow and has excellent academic records.",
      title:"Dr. Sandip K. Saha, Professor",
      subtitle:"Department of Mechanical Engineering, Indian Institute of Technology Bombay."
    }
  ] 
  return (
    <>
        ...
        <div className="container xl:mt-12 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">

            {
              data.map((item)=> {
                return(
                  <div key={item.title} className="p-4 md:w-1/2 w-11/12 m-auto">
